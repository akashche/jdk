...
/*
 * @test
 * @summary test installation of the jdk installer with all features selected
 * @library ../../tools/jpackage/helpers
 * @library ../helpers
 * @requires (os.family == "windows")
 * @modules jdk.jpackage/jdk.jpackage.internal
 *
 * @compile AllFeaturesTest.java
 * @run main/othervm jdk.jpackage.test.Main --jpt-run=AllFeaturesTest
 */
