...
/*
 * @test
 * @summary test installation of the jdk installer with default features selected
 * @library ../../tools/jpackage/helpers
 * @library ../helpers
 * @requires (os.family == "windows")
 * @modules jdk.jpackage/jdk.jpackage.internal
 *
 * @compile DefaultFeaturesTest.java
 * @run main/othervm jdk.jpackage.test.Main --jpt-run=DefaultFeaturesTest
 */
