...
/*
 * @test
 * @summary test installation of the jdk installer with only "jdk_env_java_home" feature selected
 * @library ../../tools/jpackage/helpers
 * @library ../helpers
 * @requires (os.family == "windows")
 * @modules jdk.jpackage/jdk.jpackage.internal
 *
 * @compile EnvJavaHomeTest.java
 * @run main/othervm jdk.jpackage.test.Main --jpt-run=EnvJavaHomeTest
 */
public class EnvJavaHomeTest {
    ...
    public static void test() {
        ...
        Path installed = install(msi, "ADDLOCAL=jdk_env_java_home");
        try {
