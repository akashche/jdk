...
/*
 * @test
 * @summary test installation of the jdk installer with only "jdk_registry_jar" feature selected
 * @library ../../tools/jpackage/helpers
 * @library ../helpers
 * @requires (os.family == "windows")
 * @modules jdk.jpackage/jdk.jpackage.internal
 *
 * @compile RegistryJarTest.java
 * @run main/othervm jdk.jpackage.test.Main --jpt-run=RegistryJarTest
 */
public class RegistryJarTest {
    ...
    public static void test() {
        ...
        Path installed = install(msi, "ADDLOCAL=jdk_registry_jar");
        try {
